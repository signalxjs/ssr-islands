...
Thanks for using SignalX! Here's how to get help.

## Questions and discussions

For usage questions, ideas, and general discussion, please use
[GitHub Discussions](https://github.com/signalxjs/ssr-islands/discussions). It keeps
...
- [Report a bug](https://github.com/signalxjs/ssr-islands/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/signalxjs/ssr-islands/issues/new?template=feature_request.yml)

Before filing, please:

- Check existing [issues](https://github.com/signalxjs/ssr-islands/issues?q=is%3Aissue) and
  [discussions](https://github.com/signalxjs/ssr-islands/discussions) to avoid duplicates.
